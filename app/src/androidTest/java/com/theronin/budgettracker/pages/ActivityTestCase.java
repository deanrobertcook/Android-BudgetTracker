package com.theronin.budgettracker.pages;
...
public class ActivityTestCase<T extends Activity> {
     ...
     */
    protected final Instrumentation instrumentation = InstrumentationRegistry
            .getInstrumentation();

    /**
     * An activity of the type given to the constructor for ZetaTestCase. This would be some
     * form
     * of minimal activity whose only purpose is to host a view or fragment and provide a
     * context
     * in which we can interact with that element. The activity is destroyed and recreated
     * between
     * each test.
     */
